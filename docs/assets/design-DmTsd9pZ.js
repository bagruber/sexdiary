import{a as e,i as t,n,o as r,r as i,t as a,w as o}from"./dist-FzsQM_we.js";import{t as s}from"./i18n-C2JqMYFS.js";var c=4.5,l=3,u=s(`de`),d=e=>e.toFixed(2).replace(`.`,`,`);function f(e,n,r){let i=t(e,n),a=i>=r;return`${d(i)}<span class="verdict ${a?`pass`:`fail`}">${a?`erfüllt`:`verfehlt`}</span>`}var p=[{name:`bg`,role:`Bildschirmgrund`,threshold:null},{name:`card`,role:`Fläche darüber`,threshold:null},{name:`text`,role:`Fließtext`,threshold:c},{name:`sub`,role:`Zweitrangiger Text`,threshold:c},{name:`accent`,role:`Die eine Aktionsfarbe`,threshold:l},{name:`border`,role:`Trennlinie, rein dekorativ`,threshold:null}],m=[{name:`good`,role:`Nichts zu tun`,threshold:c},{name:`warn`,role:`Erhöht`,threshold:c},{name:`bad`,role:`Handeln`,threshold:c}];function h(e,t){return`<div class="tokens"><table>
  ...
  </table></div>`}function g(e){return`<div class="scale">${Object.keys(o).sort((e,t)=>o[e]-o[t]).map(t=>{let n=r(e,t);return`<div class="step">
        <span class="dot" style="background:${n}"></span>
        <span class="lvl" style="color:${n}">${u(t)}</span>
        <span class="key">${t} → ${n.toUpperCase()}</span>
      </div>`}).join(``)}</div>`}function _(r){let o=e(r);return`<div class="page">
  <header>
  ...
  <section>
    <h2>Die Marke</h2>
    <p>
      Münchner Gelb <code>${a.surface}</code> ist eine <em>Fläche</em>,
      nie ein Vordergrund. Es erscheint auf App-Icon, Splash und Infoseite
      — im Inneren der App nirgends.
    </p>
    <div class="brand">
      <figure>
        <div class="demo" style="background:${a.surface};color:${a.onSurface}">
          So ja
        </div>
        <figcaption>
          Fläche mit <code>${a.onSurface}</code> darauf —
          ${d(t(a.onSurface,a.surface))}:1
        </figcaption>
      </figure>
      <figure>
        <div class="demo" style="background:${i.bg};color:${a.surface}">
          So nicht
        </div>
        <figcaption>
          Als Vordergrund auf <code>${i.bg}</code> —
          ${d(t(a.surface,i.bg))}:1, unter der Schwelle
          für Bedienelemente
        </figcaption>
      </figure>
    </div>
    <div class="aside">
      <p>
        ...
        nehmen — ${d(t(a.surface,n.bg))}:1 auf

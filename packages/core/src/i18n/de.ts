...
export const de: Dict = {
  ...
  qrShort: "QR",
  alertWhatIsSent: "Was übertragen wird",
  alertPayloadNote: "Empfänger-Token, Erreger und Zeitstempel. Kein Absender, kein Text.",
  alertNoRelay: "Der Server dafür ist noch nicht gebaut. Bis dahin bleibt der persönliche Weg.",
  alertSentPersonally: "Persönlich benachrichtigt am {date}",
  alertSentRelay: "Anonym gesendet am {date}",
  alertAnonPartners: "{n} Begegnung(en) ohne Kontakt lassen sich nicht benachrichtigen.",
  alertUndo: "Zurücknehmen",
  ...
  viewList: "Liste",
  viewMonth: "Monat",
  nfcCardRead: "Karte lesen",
  nfcCardWrite: "Karte beschreiben",
  nfcHold: "Karte an die Rückseite des Telefons halten",
  nfcWritten: "Token auf die Karte geschrieben",
  nfcUnavailable: "NFC ist aus oder dieses Gerät hat keines.",
  nfcNoPhoneToPhone: "Von Telefon zu Telefon geht NFC unter Android nicht mehr. Eine NFC-Karte geht.",
  nfcFailed: "Die Karte konnte nicht gelesen oder beschrieben werden.",

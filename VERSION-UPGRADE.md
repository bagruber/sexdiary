...
**Welle 4 von 4 — zuletzt.** Alle anderen Repos sind vorher dran, weil sie einfacher
...
| typescript | `^5.6.3` | `~5.9.x` |
| vite | `^5.4.11` | `^8.x` |

`packages/core` hat kein React und braucht nur `vitest ^2.1.8 -> ^4.1.x`.

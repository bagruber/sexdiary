export const en = {
  ...
  qrShort: "QR",
  alertWhatIsSent: "What gets sent",
  alertPayloadNote: "Recipient token, pathogen and timestamp. No sender, no text.",
  alertNoRelay: "The server for this is not built yet. Until then the personal route stands.",
  alertSentPersonally: "Told personally on {date}",
  alertSentRelay: "Sent anonymously on {date}",
  alertAnonPartners: "{n} encounter(s) without a contact cannot be notified.",
  alertUndo: "Undo",
  ...
  viewList: "List",
  viewMonth: "Month",
  nfcCardRead: "Read a card",
  nfcCardWrite: "Write to a card",
  nfcHold: "Hold the card against the back of the phone",
  nfcWritten: "Token written to the card",
  nfcUnavailable: "NFC is off, or this device has none.",
  nfcNoPhoneToPhone: "Phone to phone no longer works on Android. An NFC card does.",
  nfcFailed: "The card could not be read or written.",
